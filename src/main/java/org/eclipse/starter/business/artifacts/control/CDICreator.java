...
public class CDICreator extends AbstractCreator {
    ...
    public void createCDIFilesForWeb(JessieModel model) {
        ...
        createBeansXmlFile(model, variables);
    }

    private void createBeansXmlFile(JessieModel model, Map<String, Object> variables) {
        ...
        String beansXMLContents = thymeleafEngine.processFile("beans.xml", variables);
