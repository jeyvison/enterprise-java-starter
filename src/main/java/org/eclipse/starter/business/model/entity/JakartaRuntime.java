...
public enum JakartaRuntime {
    ...
    JakartaRuntime(String code, String displayName, List<MicroProfileVersion> mpVersions, String jarFileName) {
        this.code = code;
    ...
    public static JakartaRuntime valueFor(String data) {
        JakartaRuntime result = null;
        for (JakartaRuntime jakartaRuntime : JakartaRuntime.values()) {
            if (jakartaRuntime.code.equals(data)) {
                result = jakartaRuntime;
            }
        }
        return result;
    }
