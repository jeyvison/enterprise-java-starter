...
public class KafkaClientFeature extends AbstractFeature {
    ...
    public void initProperties(JessieModel model) {
        ...
        features.put("https://central.maven.org/maven2/org/apache/kafka/kafka-clients/1.1.0/kafka-clients-1.1.0.jar", "kafka-clients-1.1.0.jar");
        ...
        dependencies.add(new MavenDependency("org.apache.kafka", "kafka-clients", "1.1.0"));
    }
